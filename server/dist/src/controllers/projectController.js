...
const prisma = new client_1.PrismaClient(); // use prisma and grab data from our database
const getProjects = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const projects = yield prisma.project.findMany(); //findMany grabs the entire list of projects
        res.json(projects);
    }
    catch (error) {
