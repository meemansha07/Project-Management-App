...
const Navbar = () => {
    ...
    const { data: currentUser } = useGetAuthUserQuery({}); //grabbing the data from the user
            ...
            <div className='hidden items-center justify-between md:flex'>
                <div className='align-center flex h-9 w-9 justify-center'>
                    {!!currentUserDetails?.profilePictureUrl ? (
                        <Image
                                  src={`https://pm-s-images.s3.ap-south-1.amazonaws.com/${currentUserDetails.profilePictureUrl}`}
