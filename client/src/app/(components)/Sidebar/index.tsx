...
import Link from 'next/link'  // Instead of from lucide-react
...
const Sidebar = () => {
    ...
    const sidebarClassNames = `fixed flex flex-col h-[100%] justify-between shadow-xl
        transition-all duration h-full z-40 dark:bg-black overflow-y-auto bg-white 
        w-64 
        ...
        <div className='flex h-[100%] w-full flex-col justify-start'>
            ...
            <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700'>
                ...
                <h3 className='text-md font-bold tracking-wide dark:text-gray-200'> 
                    My team
                    {/* /*tracking wide gives specific leather spacing*/ }
                </h3>
            ...
            <nav className='z-10 w-full'>
                ...
                <SidebarLink icon={User} label="Uses" href="/users" />
                <SidebarLink icon={Users} label="Teams" href="/teams" />
            </nav>
                {/* PROJECTS LINKS */}
            <button onClick={() => setShowProjects((prev)=>!prev)} 
                className='flex w-full items-center justify-between px-8 py-3 text-gray-500'>
                    <span className=''>Projetcs</span>
                    {showProjects ? (
...
const SidebarLink = ({
   ...
   // isCollapsed
    ...
    //navigation for our entire page
